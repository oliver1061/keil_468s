/**
  ******************************************************************************
  * @file    stm32f030r8x_eval.c
  * @author  
  * @version 
  * @date    22-July-2019
  * @brief   This file provides firmware functions to manage Leds, push-buttons, 
  *          COM ports, SD card on SPI and temperature sensor (LM75) available on 
  *          STM32F030R8x-EVAL evaluation board from STMicroelectronics.
  ******************************************************************************
  * @attention
  *
...
GPIO_TypeDef* BUTTON_PORT[BUTTONn] = {KEY1_BUTTON_GPIO_PORT, 
...
const uint8_t BUTTON_IRQn[BUTTONn] = {KEY1_BUTTON_EXTI_IRQn,
